...
#endif
#ifndef UINTPTR_MAX
/* apparently this is not a constant expression: (sizeof(unsigned int *) * 256 - 1) so we have to
...
void UnityAssertEqualNumber(const _U_SINT expected, const _U_SINT actual, const char* msg,
...
void UnityAssertBits(const _U_SINT mask, const _U_SINT expected, const _U_SINT actual,
...
void UnityAssertEqualStringLen(const char* expected, const char* actual, const _UU32 length,
                               const char* msg, const UNITY_LINE_TYPE lineNumber);
...
void UnityAssertEqualMemory(UNITY_INTERNAL_PTR expected, UNITY_INTERNAL_PTR actual,
                            const _UU32 length, const _UU32 num_elements, const char* msg,
                            const UNITY_LINE_TYPE lineNumber);

void UnityAssertNumbersWithin(const _U_UINT delta, const _U_SINT expected, const _U_SINT actual,
                              const char* msg, const UNITY_LINE_TYPE lineNumber,
...
#ifndef UNITY_EXCLUDE_FLOAT
void UnityAssertFloatsWithin(const _UF delta, const _UF expected, const _UF actual, const char* msg,
                             const UNITY_LINE_TYPE lineNumber);

void UnityAssertEqualFloatArray(UNITY_PTR_ATTRIBUTE const _UF* expected,
                                UNITY_PTR_ATTRIBUTE const _UF* actual, const _UU32 num_elements,
                                const char* msg, const UNITY_LINE_TYPE lineNumber);

void UnityAssertFloatSpecial(const _UF actual, const char* msg, const UNITY_LINE_TYPE lineNumber,
                             const UNITY_FLOAT_TRAIT_T style);
#endif

#ifndef UNITY_EXCLUDE_DOUBLE
void UnityAssertDoublesWithin(const _UD delta, const _UD expected, const _UD actual,
                              const char* msg, const UNITY_LINE_TYPE lineNumber);

void UnityAssertEqualDoubleArray(UNITY_PTR_ATTRIBUTE const _UD* expected,
                                 UNITY_PTR_ATTRIBUTE const _UD* actual, const _UU32 num_elements,
                                 const char* msg, const UNITY_LINE_TYPE lineNumber);

void UnityAssertDoubleSpecial(const _UD actual, const char* msg, const UNITY_LINE_TYPE lineNumber,
                              const UNITY_FLOAT_TRAIT_T style);
#endif
...
/* This tricky series of macros gives us an optional line argument to treat it as RUN_TEST(func,
 * num=__LINE__) */
#ifndef RUN_TEST
...
/* If we can't do the tricky version, we'll just have to require them to always include the line
 * number */
#ifndef RUN_TEST
#ifdef CMOCK
...
#define UNITY_TEST_ASSERT_EQUAL_UINT8(expected, actual, line, message)                    \
    UnityAssertEqualNumber((_U_SINT)(_UU8)(expected), (_U_SINT)(_UU8)(actual), (message), \
                           (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_UINT8)
#define UNITY_TEST_ASSERT_EQUAL_UINT16(expected, actual, line, message)                     \
    UnityAssertEqualNumber((_U_SINT)(_UU16)(expected), (_U_SINT)(_UU16)(actual), (message), \
                           (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_UINT16)
#define UNITY_TEST_ASSERT_EQUAL_UINT32(expected, actual, line, message)                     \
    UnityAssertEqualNumber((_U_SINT)(_UU32)(expected), (_U_SINT)(_UU32)(actual), (message), \
...
#define UNITY_TEST_ASSERT_BITS(mask, expected, actual, line, message)                   \
    UnityAssertBits((_U_SINT)(mask), (_U_SINT)(expected), (_U_SINT)(actual), (message), \
                    (UNITY_LINE_TYPE)(line))

#define UNITY_TEST_ASSERT_INT_WITHIN(delta, expected, actual, line, message)             \
    UnityAssertNumbersWithin((delta), (_U_SINT)(expected), (_U_SINT)(actual), (message), \
                             (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_INT)
#define UNITY_TEST_ASSERT_INT8_WITHIN(delta, expected, actual, line, message)                   \
    UnityAssertNumbersWithin((_UU8)(delta), (_U_SINT)(_US8)(expected), (_U_SINT)(_US8)(actual), \
                             (message), (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_INT8)
#define UNITY_TEST_ASSERT_INT16_WITHIN(delta, expected, actual, line, message)                     \
    UnityAssertNumbersWithin((_UU16)(delta), (_U_SINT)(_US16)(expected), (_U_SINT)(_US16)(actual), \
...
#define UNITY_TEST_ASSERT_INT32_WITHIN(delta, expected, actual, line, message)                     \
    UnityAssertNumbersWithin((_UU32)(delta), (_U_SINT)(_US32)(expected), (_U_SINT)(_US32)(actual), \
...
#define UNITY_TEST_ASSERT_UINT8_WITHIN(delta, expected, actual, line, message)                     \
    UnityAssertNumbersWithin((_UU8)(delta), (_U_SINT)(_U_UINT)(_UU8)(expected),                    \
...
#define UNITY_TEST_ASSERT_UINT16_WITHIN(delta, expected, actual, line, message)   \
    UnityAssertNumbersWithin((_UU16)(delta), (_U_SINT)(_U_UINT)(_UU16)(expected), \
                             (_U_SINT)(_U_UINT)(_UU16)(actual), (message),        \
                             (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_UINT16)
#define UNITY_TEST_ASSERT_UINT32_WITHIN(delta, expected, actual, line, message)   \
    UnityAssertNumbersWithin((_UU32)(delta), (_U_SINT)(_U_UINT)(_UU32)(expected), \
                             (_U_SINT)(_U_UINT)(_UU32)(actual), (message),        \
                             (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_UINT32)
...
#define UNITY_TEST_ASSERT_EQUAL_INT_ARRAY(expected, actual, num_elements, line, message)   \
    UnityAssertEqualIntArray((UNITY_INTERNAL_PTR)(expected), (UNITY_INTERNAL_PTR)(actual), \
                             (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)(line),    \
...
#define UNITY_TEST_ASSERT_EQUAL_PTR_ARRAY(expected, actual, num_elements, line, message)           \
    UnityAssertEqualIntArray((UNITY_INTERNAL_PTR)(_UP*)(expected),                                 \
                             (UNITY_INTERNAL_PTR)(_UP*)(actual), (_UU32)(num_elements), (message), \
                             (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_POINTER)
#define UNITY_TEST_ASSERT_EQUAL_STRING_ARRAY(expected, actual, num_elements, line, message) \
    UnityAssertEqualStringArray((const char**)(expected), (const char**)(actual),           \
                                (_UU32)(num_elements), (message), (UNITY_LINE_TYPE)(line))
#define UNITY_TEST_ASSERT_EQUAL_MEMORY_ARRAY(expected, actual, len, num_elements, line, message) \
    UnityAssertEqualMemory((UNITY_INTERNAL_PTR)(expected), (UNITY_INTERNAL_PTR)(actual),         \
                           (_UU32)(len), (_UU32)(num_elements), (message),                       \
                           (UNITY_LINE_TYPE)(line))
...
#else
#define UNITY_TEST_ASSERT_FLOAT_WITHIN(delta, expected, actual, line, message)       \
    UnityAssertFloatsWithin((_UF)(delta), (_UF)(expected), (_UF)(actual), (message), \
                            (UNITY_LINE_TYPE)(line))
#define UNITY_TEST_ASSERT_EQUAL_FLOAT(expected, actual, line, message)                            \
    UNITY_TEST_ASSERT_FLOAT_WITHIN((_UF)(expected) * (_UF)UNITY_FLOAT_PRECISION, (_UF)(expected), \
                                   (_UF)(actual), (UNITY_LINE_TYPE)(line), (message))
#define UNITY_TEST_ASSERT_EQUAL_FLOAT_ARRAY(expected, actual, num_elements, line, message)         \
...
#define UNITY_TEST_ASSERT_FLOAT_IS_NEG_INF(actual, line, message)              \
    UnityAssertFloatSpecial((_UF)(actual), (message), (UNITY_LINE_TYPE)(line), \
                            UNITY_FLOAT_IS_NEG_INF)
#define UNITY_TEST_ASSERT_FLOAT_IS_NAN(actual, line, message) \
...
#else
#define UNITY_TEST_ASSERT_DOUBLE_WITHIN(delta, expected, actual, line, message)       \
    UnityAssertDoublesWithin((_UD)(delta), (_UD)(expected), (_UD)(actual), (message), \
                             (UNITY_LINE_TYPE)line)
#define UNITY_TEST_ASSERT_EQUAL_DOUBLE(expected, actual, line, message)                           \
    UNITY_TEST_ASSERT_DOUBLE_WITHIN((_UD)(expected) * (_UD)UNITY_DOUBLE_PRECISION, (_UD)expected, \
                                    (_UD)actual, (UNITY_LINE_TYPE)(line), message)
#define UNITY_TEST_ASSERT_EQUAL_DOUBLE_ARRAY(expected, actual, num_elements, line, message) \
    UnityAssertEqualDoubleArray((_UD*)(expected), (_UD*)(actual), (_UU32)(num_elements),    \
                                (message), (UNITY_LINE_TYPE)line)
#define UNITY_TEST_ASSERT_DOUBLE_IS_INF(actual, line, message) \
    UnityAssertDoubleSpecial((_UD)(actual), (message), (UNITY_LINE_TYPE)(line), UNITY_FLOAT_IS_INF)
#define UNITY_TEST_ASSERT_DOUBLE_IS_NEG_INF(actual, line, message)              \
    UnityAssertDoubleSpecial((_UD)(actual), (message), (UNITY_LINE_TYPE)(line), \
                             UNITY_FLOAT_IS_NEG_INF)
#define UNITY_TEST_ASSERT_DOUBLE_IS_NAN(actual, line, message) \
    UnityAssertDoubleSpecial((_UD)(actual), (message), (UNITY_LINE_TYPE)(line), UNITY_FLOAT_IS_NAN)
#define UNITY_TEST_ASSERT_DOUBLE_IS_DETERMINATE(actual, line, message) \
    UnityAssertDoubleSpecial((_UD)(actual), (message), (UNITY_LINE_TYPE)(line), UNITY_FLOAT_IS_DET)
#define UNITY_TEST_ASSERT_DOUBLE_IS_NOT_INF(actual, line, message)              \
    UnityAssertDoubleSpecial((_UD)(actual), (message), (UNITY_LINE_TYPE)(line), \
                             UNITY_FLOAT_IS_NOT_INF)
#define UNITY_TEST_ASSERT_DOUBLE_IS_NOT_NEG_INF(actual, line, message)          \
